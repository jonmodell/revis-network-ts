...
const EditLayer = (props: { panScaleState: any; screen: any; interactionState: any; color?: any; shapes?: any; showMutedOverlay?: any; }) => {
  const {
    panScaleState,
    screen,
    interactionState,
  ...
  const editRef = React.useRef<HTMLCanvasElement>(null);

  const drawHandle = (context: CanvasRenderingContext2D, x: number, y: number, s: any, selected = false) => {
    if (selected) {
